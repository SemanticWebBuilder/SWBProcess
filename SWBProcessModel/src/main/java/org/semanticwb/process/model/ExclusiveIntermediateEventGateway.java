...
/**
 * Clase que encapsula las propiedades y comportamiento de una compuerta
 * exclusiva basada en eventos en un flujo de procesos.
 * 
 * @author Javier Solís
 * @author Hasdai Pacheco
 *
 */
public class ExclusiveIntermediateEventGateway
		extends org.semanticwb.process.model.base.ExclusiveIntermediateEventGatewayBase {
	/**
	 * Constructor.
	 * 
	 * @param base
	 */
	public ExclusiveIntermediateEventGateway(SemanticObject base) {
		super(base);
	}
