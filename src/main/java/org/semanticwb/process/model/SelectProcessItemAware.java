...
public class SelectProcessItemAware extends org.semanticwb.process.model.base.SelectProcessItemAwareBase {
	...
	public String renderElement(HttpServletRequest request, SemanticObject obj, SemanticProperty prop, String propName,
		...
		SemanticObject objc = obj;
		if (objc == null) {
			objc = new SemanticObject();
		}
		...
		if (prop.isObjectProperty()) {
			...
			Iterator<SemanticObject> it2 = objc.listObjectProperties(prop);
			...
			String value = objc.getDisplayName(lang);
			...
			if (mode.equals("edit") || mode.equals("create")) {
				...
				if (isGlobalScope()) {
					...
					if (objc.instanceOf(ThrowMessageable.swp_ThrowMessageable)) {
						FlowNode fn = (FlowNode) objc.createGenericInstance();
