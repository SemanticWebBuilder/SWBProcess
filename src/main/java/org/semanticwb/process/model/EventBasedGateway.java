...
/**
 * Clase que encapsula las propiedades y comportamiento de una compuerta basada
 * en eventos en un flujo de procesos.
 * 
 * @author Javier Solís
...
public class EventBasedGateway extends org.semanticwb.process.model.base.EventBasedGatewayBase {
	...
	public void nextObject(FlowNodeInstance instance, User user) {
		...
		// SI LA COMPUERTA ES CONVERGENTE, PASAR EL CONTROL CON EL PRIMER FLUJO DE
		// LLEGADA
	}
}
