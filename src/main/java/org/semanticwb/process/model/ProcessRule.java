...
/**
 * Clase que encapsula las propiedades y comportamiento de una Regla de Negocio en la ejecución de un proceso.
 * @author Javier Solís
 * @author Hasdai Pacheco
 */
public class ProcessRule extends org.semanticwb.process.model.base.ProcessRuleBase 
{
    private static final Logger LOG = SWBUtils.getLogger(ProcessRule.class);
