...
<%
  ...
  if (p != null) {
      ...
      if (itTemplateCont == null || !itTemplateCont.hasNext()) {
        ...
        Iterator<DocumentSectionInstance> itdsi = SWBComparator.sortSortableObject(di.listDocumentSectionInstances());//Regerar c�digo para ordenamiento
                          ...
                          <tr id="trse<%= se.getId()%>">
                            ...
                            <td data-title="<%=paramRequest.getLocaleString("lblActions")%>" class="swbp-action-table">
                              ...
                              if (!isReference) {
                                ...
                                %>
                                <a class="btn btn-default col-lg-4 col-md-4 fa fa-gears" href="<%= captureUrl + "?idp=" + pr.getId() + "&pg=" + pg + "&p=" + pag + "#" + se.getDocumentSectionInst().getId()%>" target="_blank" data-original-title="<%= pr.getTitle()%>">
                                </a>
                                <%
                              }
                              %>
                            ...
                            <ul class="list-unstiled list-inline">
                              ...
                              <li>
                                <a href="<%= urlFill.setParameter("fill", "428bca").setParameter("urise", act.getURI())%>" class="colorPicker">
                                  <span class="fa fa-square" id="428bca" style="color: #428bca;"></span></a>
                              </li>
                              <li>
                              ...
                              <li>
                                <a href="<%= urlFill.setParameter("fill", "5bc0de").setParameter("urise", act.getURI())%>" class="colorPicker">
                                  <span class="fa fa-square"  id="5bc0de" style="color: #5bc0de;"></span></a>
                              </li>
                              <li>
                                <a href="<%= urlFill.setParameter("fill", "f0ad4e").setParameter("urise", act.getURI())%>" class="colorPicker">
                                  <span class="fa fa-square" id="f0ad4e" style="color: #f0ad4e;"></span></a>
                              </li>
                              <li>
                                <a href="<%= urlFill.setParameter("fill", "d9534f").setParameter("urise", act.getURI())%>" class="colorPicker">
                                  <span class="fa fa-square" id="d9534f" style="color: #d9534f;"></span></a>
                              </li>
                            </ul>
                          </ul>
                        </div>
