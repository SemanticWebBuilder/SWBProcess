...
public abstract class RoleBase extends org.semanticwb.process.documentation.model.SectionElement implements org.semanticwb.process.documentation.model.Instantiable,org.semanticwb.model.Traceable,org.semanticwb.model.Sortable,org.semanticwb.model.Descriptiveable,org.semanticwb.process.documentation.model.ElementReferable
{
   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.documentation.model.Role with a determined DocumentSectionInst
       * @param value DocumentSectionInst of the type org.semanticwb.process.documentation.model.DocumentSectionInstance
       * @param model Model of the org.semanticwb.process.documentation.model.Role
       * @return Iterator with all the org.semanticwb.process.documentation.model.Role
       */

        public static java.util.Iterator<org.semanticwb.process.documentation.model.Role> listRoleByDocumentSectionInst(org.semanticwb.process.documentation.model.DocumentSectionInstance value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.Role> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentSectionInst, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.documentation.model.Role with a determined DocumentSectionInst
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.documentation.model.Role> listRoleByDocumentSectionInst(org.semanticwb.process.documentation.model.DocumentSectionInstance value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.Role> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentSectionInst,value.getSemanticObject(),sclass));
            return it;
        }
       /**
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.documentation.model.Role with a determined DocumentTemplate
       * @param value DocumentTemplate of the type org.semanticwb.process.documentation.model.DocumentTemplate
       * @param model Model of the org.semanticwb.process.documentation.model.Role
       * @return Iterator with all the org.semanticwb.process.documentation.model.Role
       */

        public static java.util.Iterator<org.semanticwb.process.documentation.model.Role> listRoleByDocumentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.Role> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentTemplate, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.documentation.model.Role with a determined DocumentTemplate
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.documentation.model.Role> listRoleByDocumentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.Role> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swpdoc_documentTemplate,value.getSemanticObject(),sclass));
            return it;
        }
    }
