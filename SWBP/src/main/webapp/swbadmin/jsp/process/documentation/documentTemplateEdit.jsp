            ...
            <div class="panel-body swbp-panel-body-card">
                ...
                <div class="form-group">
                    ...
                    <div class="row no-margin text-right">
                        <a href="<%= url.setMode(SWPDocumentTemplateResource.MODE_ADD_DOCUMENT_SECTION).setParameter("uridt", docTemplate.getURI()).setParameter("uritc", docTemplate.getURI()) %>" data-toggle="modal" data-target="#modalDialog" class="btn btn-default swbp-btn-inter2" role="button">Agregar secci�n</a>
                    </div>
                </div>
                <%
                if (docTemplate != null) {
                    ...
                    if (itds.hasNext()) {
                        ...
                        <script>
                            $("a.btn-ajax-action.btn-ajax-action-remove").on("click", function(evt) {
                                evt.preventDefault();
                                if (!confirm("�Desea eliminar esta secci�n?")) return false;
