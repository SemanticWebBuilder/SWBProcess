...
<div class="row">
    <div class="col-sm-4">
        <div class="panel panel-default">
            <div class="panel-heading">Desempe�o</div>
            <div class="panel-body">
                <div id="performanceGraph" class="row">
                    <div class="col-xs-12"><p class="text-center">Sin informaci�n</p></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
               <div id="participationGraph" class="row">
                   <div class="col-sm-12"><p class="text-center">Sin informaci�n</p></div>
               </div>
            </div>
       </div>
    </div-->
