                    ...
                    if(sTagVarName.equalsIgnoreCase(varName)){
                        ...
                        while(itClassProps.hasNext()){
                            ...
                            if(semProp.getName().endsWith(sTagProp)){
                                //Manejo de modo
                                String swbMode=SWBProcessFormMgr.MODE_EDIT;
                                FormElement frme=null;
                                if(smode!=null && smode.length()>0) swbMode=smode;
                                if(swbMode.equalsIgnoreCase("edit")) swbMode=SWBProcessFormMgr.MODE_EDIT;
                                else if(swbMode.equalsIgnoreCase("view")) swbMode = SWBProcessFormMgr.MODE_VIEW;
                                if(sformElement!=null && sformElement.length()>0 && hMapFE.size()>0){
