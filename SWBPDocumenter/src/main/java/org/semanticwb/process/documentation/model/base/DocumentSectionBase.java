...
public abstract class DocumentSectionBase extends org.semanticwb.model.SWBClass implements org.semanticwb.process.documentation.model.Prefixeable,org.semanticwb.model.Traceable,org.semanticwb.model.Sortable,org.semanticwb.model.Descriptiveable,org.semanticwb.model.Activeable
{
   ...
   */
    ...
    public static class ClassMgr
    {
       ...
       */
       ...
       /**
       * Gets all org.semanticwb.process.documentation.model.DocumentSection with a determined ParentTemplate
       * @param value ParentTemplate of the type org.semanticwb.process.documentation.model.DocumentTemplate
       * @param model Model of the org.semanticwb.process.documentation.model.DocumentSection
       * @return Iterator with all the org.semanticwb.process.documentation.model.DocumentSection
       */

        public static java.util.Iterator<org.semanticwb.process.documentation.model.DocumentSection> listDocumentSectionByParentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value,org.semanticwb.model.SWBModel model)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.DocumentSection> it=new org.semanticwb.model.GenericIterator(model.getSemanticObject().getModel().listSubjectsByClass(swpdoc_parentTemplate, value.getSemanticObject(),sclass));
            return it;
        }
       /**
       * Gets all org.semanticwb.process.documentation.model.DocumentSection with a determined ParentTemplate
       ...
       */
        ...
        public static java.util.Iterator<org.semanticwb.process.documentation.model.DocumentSection> listDocumentSectionByParentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value)
        {
            org.semanticwb.model.GenericIterator<org.semanticwb.process.documentation.model.DocumentSection> it=new org.semanticwb.model.GenericIterator(value.getSemanticObject().getModel().listSubjectsByClass(swpdoc_parentTemplate,value.getSemanticObject(),sclass));
            return it;
        }
    }
...
*/
   ...
   */
    ...
    public void setParentTemplate(org.semanticwb.process.documentation.model.DocumentTemplate value)
    {
        if(value!=null)
        {
   ...
   */
    public org.semanticwb.process.documentation.model.DocumentTemplate getParentTemplate()
    {
