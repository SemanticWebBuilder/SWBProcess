...
public class UserTaskInboxResource extends org.semanticwb.process.resources.taskinbox.base.UserTaskInboxResourceBase {
   ...
   */
    ...
    public void doAdmin(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        sb.append(mgr.renderLabel(request, swpres_viewJSP, SWBFormMgr.MODE_VIEW));
        sb.append("        </td>");
        sb.append("        <td>");
        sb.append(mgr.renderElement(request, swpres_viewJSP, SWBFormMgr.MODE_EDIT));
        sb.append("        </td>");
        sb.append("      </tr>");
        sb.append("      <tr>");
        sb.append("        <td width=\"200px\" align=\"right\">");
        sb.append(mgr.renderLabel(request, swpres_itemsPerPage, SWBFormMgr.MODE_VIEW));
        sb.append("        </td>");
        sb.append("        <td>");
        sb.append(mgr.renderElement(request, swpres_itemsPerPage, SWBFormMgr.MODE_EDIT));
        sb.append("        </td>");
        sb.append("      </tr>");
        sb.append("      <tr>");
        sb.append("        <td width=\"200px\" align=\"right\">");
        sb.append(mgr.renderLabel(request, swpres_displayMapWp, SWBFormMgr.MODE_VIEW));
        sb.append("        </td>");
        sb.append("        <td>");
        sb.append(mgr.renderElement(request, swpres_displayMapWp, SWBFormMgr.MODE_EDIT));
        sb.append("        </td>");
        sb.append("      </tr>");
        sb.append("      <tr>");
        sb.append("        <td width=\"200px\" align=\"right\">");
        ...
        sb.append("        </td>");
        sb.append("        <td>");
        sb.append(mgr.renderElement(request, swpres_showProcessWPLink, SWBFormMgr.MODE_EDIT));
        sb.append("        </td>");
        sb.append("      </tr>");
        sb.append("      <tr>");
        sb.append("        <td width=\"200px\" align=\"right\">");
        sb.append(mgr.renderLabel(request, swpres_allowForward, SWBFormMgr.MODE_VIEW));
        sb.append("        </td>");
        sb.append("        <td>");
        sb.append(mgr.renderElement(request, swpres_allowForward, SWBFormMgr.MODE_EDIT));
        sb.append("        </td>");
        sb.append("      </tr>");
        sb.append("      <tr>");
        sb.append("        <td width=\"200px\" align=\"right\">");
        sb.append(mgr.renderLabel(request, swpres_showAutoCreated, SWBFormMgr.MODE_VIEW));
        sb.append("        </td>");
        sb.append("        <td>");
