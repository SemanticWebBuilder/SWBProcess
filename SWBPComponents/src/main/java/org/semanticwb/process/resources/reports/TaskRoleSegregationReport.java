...
/**
 * Componente que genera un reporte de segregación de roles de procesos.
 * @author Hasdai Pacheco
 */
public class TaskRoleSegregationReport {
    private static final Logger LOG = SWBUtils.getLogger(TaskRoleSegregationReport.class);
