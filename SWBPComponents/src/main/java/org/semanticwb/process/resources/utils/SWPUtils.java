...
public class SWPUtils {
    ...
    public static void generateImageModel(Process p, String path, String format,
    ...
    /**
     * Transforms request parameters to a JSON String for resource responses.
     * @param params Map of request parameters
     * @return JSON String for resource responses.
     */
    public static String getJSONResponse(Map<String, Object> params) {
        ...
        while (keys.hasNext()) {
            ...
            ret.append("\"").append(key).append("\":\"").append(params.get(key)).append("\"");
            if (keys.hasNext()) {
                ret.append(",");
            }
        }
